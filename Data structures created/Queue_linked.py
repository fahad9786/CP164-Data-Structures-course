"""
-------------------------------------------------------
Linked version of the queu ADT.
-------------------------------------------------------
Author:  Fahad Sheikh
ID:      169030180
...
class Queue:
    ...
    def __eq__(self, target):
        ...
        if self._count != target._count:
            ...
            sourceNode = self._front 
            currNode = target._front 
            
            while sourceNode is not None and sourceNode._value == currNode._value:     
                sourceNode = self._front._next
                currNode = target._front._next
