...
class Movie:
    ...
    def genres_menu():
        ...
        # initlizae a string
        string = "Genres\n"
        # for the range of the list movie GENRES
        # print each genres position and then print the index of whatevr is at i
...
Genres:   {}""".format(self.title, self.year, self.director, self.rating, genres_list)
    ...
    def genres_string(self):
        ...
        #go through each number the users given
        
        try:
            for i in self.genres:
                # for every genre in the csonstant 
    ...
    def genres_list_string(self):
        ...
        #empty  string
        string = ""
        #going through the genre list 
        try:
            for i in self.genres:
            #turn each number into a string with comma
