...
class List:
    ...
    def combine(self, source1, source2):
        ...
        while(left):
            ...
            if(len(source1) > 0 and i % 2 == 0):
                x = source1.pop(0)
                self._values.append(x)
                
            elif(len(source2) > 0 and i % 2 != 0):
                y = source2.pop(0)
    ...
    def remove(self, key):
        ...
        # Your code here
        i = self._linear_search(key)
        # if value not present or list isnt empty return none 
        if self.is_empty():
            value = None
